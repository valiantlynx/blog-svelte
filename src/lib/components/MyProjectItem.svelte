...
<div
	class="w-full flex flex-col sm:flex-row sm:items-center gap-3 p-4 bg-base-200 rounded-lg hover:shadow-md transition-shadow"
>
	...
	<div class="flex items-center flex-wrap gap-2 sm:flex-shrink-0">
